######################################################################
# This script is for WGCNA network construction
...
### threshold selecting for power adj construction
...
# choose power = 4 as threshold


### network construction

net = blockwiseModules(dat, power = 4,
